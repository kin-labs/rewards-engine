...
`Let KRE_prior_buy_payouts_i be the summed Kin paid to app i over the lifetime of the KRE (including grants)`<br/> 
...
`Payout_buy_i = min(KRE_buy * net_demand_i / (sum for all apps j buy_demand_j), net_demand_i)`
