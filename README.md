...
# Kin Rewards Engine
This is the repository for the Kin Rewards Engine, or "KRE", which is overseen by the Kin Foundation. Here you will find the latest iterations and resources pertaining to the KRE, as well as a place to submit improvement proposals. Fraud & spam prevention will continue to be provided as a service privately.

## Resources
To view the current KRE and spend guidelines, review the [current-KRE](current-KRE.md) and [current-valid-spend-guidelines](current-valid-spend-guidelines.md) guides, respectively.
...
The Kin Ecosystem currently runs on [Solana](https://solana.com/), a fast, secure, and censorship resistant blockchain.
